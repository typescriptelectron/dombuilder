...
exports.chooseFile = function (id, title, buttonLabel) {
...
var procs = [];
exports.spawnProc = function (id, path, args) {
    try {
        procs[id].kill();
    }
    catch (err) {
    ...
    try {
        ...
        proc.stdout.on("data", function (data) {
            ...
            lines.map(function (line) { return mainWindow.webContents.send(id, { spawn: true, error: false, data: line, note: "stdout" }); });
        });
...
exports.writeToProc = function (id, content) {
    try {
        var proc = procs[id];
...
exports.gitApiRequest = function (arg) {
    ///////////////////////////////////////
    /*
    arg{
      action:string,
    ...
    */
    ...
    axios(config).then(function (response) {
        return mainWindow.webContents.send(id, {
            ok: true,
            action: action,
